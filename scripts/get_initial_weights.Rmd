...
\begin{wrapfigure}{l}{0.4\textwidth}
  \centering
    \includegraphics[width=0.4\textwidth]{../graphics/maps/GunnisonGorgeAIMPlots.png}
...
Of the `r drawnStrata(GG_NM)` strata which had plots drawn within the NCA, only `r SampledStrata(GG_NM)` were successfully sampled. ...
