...
```{r UFO map,  fig.cap = "All plots sampled across the Uncompahgre Field Office"}
knitr::include_graphics('../graphics/maps/AIMPlots.png')
```
...
Full_newWghts %>% 
  ...
  arrange(-TotalAcres) %>% 
  select(Stratum, WgtAcres, PlotsSampled, PlotsRejected) %>% 
  knitr::kable(., digits = 2, format.args = list(big.mark = ","), booktabs = T,
               col.names = c('Stratum',  'Plot Wt.', 'Sampled', 'Rejected'),
               caption = "Realized Weighted Sample Design for the Entire Sample Frame", 
               align = c("c", rep('r', times = (ncol(.) - 1)))) %>% 
  kableExtra::add_header_above(., c(" " = 2,  "No. Plots" = 2))
...
OW_newWghts %>% 
  ...
  knitr::kable(., digits = 2, format.args = list(big.mark = ","), booktabs = T,
               col.names = c('Stratum',  'Plot Wt.', 'Sampled', 'Rejected'),
               caption = "Realized Weighted Sample Design for the Dominguez-Escalente", 
               align = c("c", rep('r', times = (ncol(.) - 1)))) %>% 
  kableExtra::add_header_above(., c(" " = 2,  "No. Plots" = 2))
...
GG_newWghts %>% 
  ...
  knitr::kable(., digits = 2, format.args = list(big.mark = ","), booktabs = T,
               col.names = c('Stratum',  'Plot Wt.', 'Sampled', 'Rejected'),
               caption = "Realized Weighted Sample Design for the Gunnison Gorge NM", 
               align = c("c", rep('r', times = (ncol(.) - 1)))) %>% 
  kableExtra::add_header_above(., c(" " = 2,  "No. Plots" = 2))
