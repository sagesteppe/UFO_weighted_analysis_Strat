...
\begin{wrapfigure}{l}{0.4\textwidth}
  \centering
    \includegraphics[width=0.4\textwidth]{../graphics/maps/DominguezEscalenteAIMPlots.png}
...
The three plots drawn in the Aspen and Mixed Conifer strata were unable to be sampled, as mentioned due to the isolated and difficult topography of portions of the NCA. One plot fewer than desired in the drawn Sagebrush stratum was sampled, however more plots than expected were sampled in the Pinyon-Juniper and Salt Desert strata.
