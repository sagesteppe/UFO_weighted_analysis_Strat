...
og1 <- originalWeights(
  sample_area = uFO_remains, strat_raster = strat_raster, pt_data = pts_base)

pts_base <- og1[[1]]
OriginalWeights1 <- og1[[2]]


unique(OriginalWeights1$Stratum)
...
Full_newWghts <- plotWeigher(OriginalWeights1, pts_base)
