...
The majority of land administered by the field office does not fall under any special regulatory status, such as those for the ACEC's and National Conservation Areas. The initial AIM sample design covered the entirety of the Field Office, and did not separate out, or weigh, the special regulatory areas from the majority of BLM administered land. Given that this area is managed differently than the following three other areas, and that it has different management objectives, we split this area out retroactively. Here we assess the location of the plots from the original sample design, and assign them to this area, and determine the weights of plots under the scenario that all plots were sampled, and under the realized condition that only certain plots were sampled. 

\begin{wrapfigure}{l}{0.5\textwidth}
  \centering
    \includegraphics[width=0.5\textwidth]{../graphics/maps/AIMPlots.png}
