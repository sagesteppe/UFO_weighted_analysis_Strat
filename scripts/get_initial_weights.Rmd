...
rm(deSS, lookup_table, monuments, strat_raster, GGnm, ggarea)
```
...
rm(GG_deNM, GG_deNM_pts, pts, GG_newWghts)
```
...
```{r}
rm(OriginalWeights_results, NewWeights_results, points, originalWeights, plotWeigher)
```
